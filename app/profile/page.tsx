...
const ProfileSettingsPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* The Sidebar component should be configured to highlight 'Profile Settings' */}
      <Sidebar />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="flex items-center space-x-6 mb-8">
                ...
                <div>
                  <button className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-150 mr-3">
                    Change Photo
                  </button>
                  <button className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition duration-150">
                    Remove
                  </button>
                </div>
              </div>
            ...
            <SettingsSectionCard
              ...
              description={settingsSections[2].description}
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Theme Selector */}
                <label className="block">
            ...
            >
              <div className="flex justify-between items-center bg-red-50 border border-red-300 p-4 rounded-lg">
                <div>
                ...
                <button className="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 transition duration-150">
                  Delete Account
                </button>
              </div>
            </SettingsSectionCard>
